...
/**
 * Anonymouth Constants and such (To help clean up ThePresident, which now
 * focuses solely on starting up Anonymouth). Any global booleans, paths,
 * directories, or widely used constants should go in here.
 *
...
public class ANONConstants {
	...
	public static final boolean SAVE_TAGGED_DOCUMENTS = true; // TODO: Put in Preferences and create implementation for
																// it
	...
	public static final boolean SHOW_TRANSLATION_NAME_LABELS = false; // For translations in the translations holder
																		// scroll pane
	...
	public static final String DUMMY_NAME = "~* you *~"; // NOTE DO NOT CHANGE THIS unless you have a very good reason
															// to do so.
	...
	/**
	 * Used for the Hide/Show menu items<br>
	 * <br>
	 * Keeps track of whether or not certain components are visible to the user.
	 * Please not this is NOT the same thing as isVisible(), we are still keeping
	 * and updating those components in the background and they are still "visible"
	 * ready to go, the only difference is we don't actually have them added to the
	 * frame or not (depending on which state they are in).
	 *
	 * @author Marc Barrowclift
	 */
	public enum STATE {
	...
	/**
	 * Used for determining what state the currently focused sentence is in in terms
	 * of translations
	 *
	 * <ul>
	 * <li>EMPTY: No translations have been done yet (show the translate button)
	 * <li>PROCESSING: The sentence is in the process of being translated (show the
	 * progress bar)
	 * <li>DONE: The sentence has recieved all translations (hide completely)
	 * </ul>
	 *
	 * @author Marc Barrowclift
	 */
