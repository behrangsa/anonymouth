...
/**
 * Enumeration of all types of baselines for normalization for any feature. A
 * feature is a specific entry in the features vector, for instance the
 * appearances of the digit '5'. A feature class is all features of the same
 * type derived from the same event driver, for instance appearances of all
 * digist ('0', '1' etc.).
 *
...
public enum NormBaselineEnum {
	...
	NONE("None", "No normalization - absolute values."),

	// feature class within the current document, e.g. all appearances of digits in
	// the document
	...
	// appearances of the specific feature across all documents in the training
	// corpus
	 ...
	 * @return The normalization baseline enum with the given title.
	 */
	...
	public static void main(String[] args) {
		Logger.logln(NormBaselineEnum.valueOf("NONE").getDescription());
	}
}
