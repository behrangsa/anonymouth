...
/**
 * The Feature Driver class is designed to hold a configuration for feature set
 * extraction, based on a JGAAP event driver, list of JGAAP canonicizers to
 * apply on the documents parsed by this event driver, list of JGAAP event
 * cullers to apply on the extracted event sets and normalization configuration
 * - pair of normalized technique and factoring constant.
 *
...
public class FeatureDriver {
	...
	/**
	 * Defines whether to calculate a value from a histogram generated from the
	 * underlying event driver's event set output, or simply take a numeric value
	 * from the first (and only) event in that event set.
	 */
	...
	/**
	 * The normalization and factorization to apply at the features (events)
	 * extracted by this event driver.
	 */
	...
	/**
	 * Constructor for a feature driver, initialized with the given event driver,
	 * empty list of canonicizers, empty list of event cullers and no normalization
	 * and factoring.
	 *
	 * @param name
	 *            The name of the feature driver. Should be short.
	 * @param calcHist
	 *            Defines whether to calculate histogram of the output event set, or
	 *            simply take the numeric value of the only event in that event set.
	...
	/**
	 * Constructor for a feature driver, initialized with the given event driver,
	 * list of canonicizers, list of event cullers and no normalization and
	 * factoring.
	 *
	 * @param name
	 *            The name of the feature driver. Should be short.
	 ...
	 *            The JGAAP event driver to be used.
	 * @param canonicizers
	 *            The list of canonicizers to be applied on the parsed documents
	 *            when applying this feature driver.
	 * @param cullers
	 *            The list of event cullers to be applied when applying this feature
	 *            driver.
	 */
	...
	/**
	 * Constructor for a feature driver, initialized with the given event driver,
	 * empty list of canonicizers, empty list of event cullers, but with
	 ...
	 *            The JGAAP event driver to be used.
	 * @param normalization
	 *            The pair of normalization technique and factor to be applied on
	 *            the event set generated by this feature driver. n
	 */
	public FeatureDriver(String name, boolean calcHist, EventDriver underlyEventDriver,
			Pair<NormBaselineEnum, Double> normalization) {
		this(name, calcHist, underlyEventDriver);
	...
	/**
	 * Constructor for a feature driver, initialized with the given event driver,
	 * list of canonicizers, list of event cullers, normalization and factoring.
	 *
	 * @param name
	 *            The name of the feature driver. Should be short.
	 * @param calcHist
	 ...
	 * @param normalization
	 *            The pair of normalization technique and factor to be applied on
	 *            the event set generated by this feature driver.
	 */
	public FeatureDriver(String name, boolean calcHist, EventDriver underlyEventDriver, List<Canonicizer> canonicizers,
	...
	/**
	 * Sets whether to calculate histogram over the output event set or simply take
	 * the numeric value of the (only) event in that event set.
	 *
	 * @param calcHist
	 *            Defines whether to calculate histogram over the output event set
	 *            or simply take the numeric value of the (only) event in that event
	 *            set.
	 */
	 ...
	 *
	 * @return The name of the feature driver.
	 */
	 ...
	 *
	 * @return The description of the feature driver.
	 */
	 ...
	 *
	 * @return The underlying event driver.
	 */
	...
	/**
	 * Returns whether to calculate histogram over the output event set or simply
	 * take the numeric value of the (only) event in that event set.
	 *
	 * @return Whether to calculate histogram over the output event set or simply
	 *         take the numeric value of the (only) event in that event set.
	 */
	 ...
	 * @return The canonicizer at the given index, or null if does not exist.
	 */
	 ...
	 *
	 * @return The list of canonicizers.
	 */
	 ...
	 * @return The event culler at the given index, or null if does not exist.
	 */
	 ...
	 *
	 * @return The list of event drivers.
	 */
	 ...
	 *
	 * @return The normalization baseline.
	 */
	...
	public Double getNormFactor() {
		return norm.getSecond() == null ? 1.0d : norm.getSecond();
	}

	/**
	 * Returns the pair of normalization baseline and factor.
	 *
	 * @return The pair of normalization baseline and factor.
	 */
	...
	/**
	 * Returns the list of parameters of a given JGAAP EventDriver class. This
	 * method should correspond to GUI.FeatureWizardDriver.getConfigPanel()
	 *
	 * @param className
	 *            The name of the event driver class.
	 * @return The list of parameters of a given JGAAP EventDriver class.
	 */
	...
	public enum ParamTag {
		FILE_PATH, CLASS_NAME, INTEGER, DOUBLE, BOOLEAN, STRING
	}
}
