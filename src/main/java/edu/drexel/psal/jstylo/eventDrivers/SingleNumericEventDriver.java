...
/**
 * Abstract class for event drivers that designed to hold a single event of a
 * numeric value, e.g. sentence count, average syllables in word, etc.
 *
...
public abstract class SingleNumericEventDriver extends EventDriver {
	 ...
	 * @return The numeric value of the single event in the event set extracted.
	 */
