	...
	public static void initListeners(final ClassWizard cw) {
		...
		cw.applyJButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				for (Argument a : args) {
					if (a.getValue() == null || a.getValue().equals("") || a.getValue().equals(" ")) { // if the arg
																										// doesn't have
																										// any value at
																										// all, don't
																										// add it
				...
				cw.parent.classAvClassArgsJTextField
						.setText(edu.drexel.psal.jstylo.GUI.ClassTabDriver.getOptionsStr(cw.tmpAnalyzer.getOptions()));
				cw.dispose();
			}
		});
