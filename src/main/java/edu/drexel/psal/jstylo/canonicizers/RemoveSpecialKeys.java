...
public class RemoveSpecialKeys extends Canonicizer {
	...
	protected static String SPECIAL_KEYS_PATH = "edu/drexel/psal/resources/special_keys.txt";
	...
	public RemoveSpecialKeys() {
		...
		if (map == null)
			try {
				InputStream in = getClass().getClassLoader().getResourceAsStream(SPECIAL_KEYS_PATH);
	...
	public static void main(String[] args) {
		String test = "βββββRebecca	Bailey	rebphotography@yahoo.com	\n"
