...
public class Cluster {
	...
	/**
	 * Moves the current value of the centroid to the new one, as specified by
	 * 'newCentroid'
	 *
	 * @param newCentroid
	 *            - 'double' (primitive type) target value for updated centroid
	 */
	 ...
	 *
	 * @param element
	 *            - 'Pair' value that has been previously added
	 * @return the input parameter if successfully removed, and 'null' otherwise.
	 */
	 ...
	 *
	 * @return ArrayList of Pair values
	 */
	 ...
	 *
	 * @return double value of centroid
	 */
	...
	/**
	 * Calculates the average absolute deviation of the element's values from the
	 * centroid (average). This is a more robust calculation than standard
	 * deviation, and produces a more reliable statistic when the distribution is
	 * not expected to be normal.
	 *
	 * @return double type, average absolute deviation
	 */
	...
	public String toString() {
		return "[ centroid: " + centroid + ", cluster number: " + clusterNumber + ", number of documents: "
				+ elements.size() + " ]";
	}
}
