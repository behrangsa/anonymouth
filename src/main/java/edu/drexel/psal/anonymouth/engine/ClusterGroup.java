...
/**
 * holds a group of clusters pertaining to one or more documents, and
 * facilitates operations on it.
 *
...
public class ClusterGroup implements Comparable<ClusterGroup> {
	 ...
	 *
	 * @param groupKey
	 *            the key containing cluster preference numbers by feature for this
	 *            group of clusters
	 * @param preferenceValue
	 *            the calculated value that identifies this clusterGroup's
	 *            desirability as being the user's set of targets
	 */
	...
	/**
	 * returns a string representation of this object, in the form of: 'groupKey' -
	 * {'preferenceValue}
	 */
	...
	/**
	 * method to allow sorting (greatest to least) based on preferenceValue (as
	 * determined by @ClusterAnalyzer,
	 * SmartIntegerArray_one.compareTo(SmartIntegerArray_two);
	 *
	 * @param obj
	 *            a @SmartIntegerArray
	 * @return 1 if *_one < *_two -1 if *_one > *_two 0 if *_one == *_two
	 */
