...
/**
 * Adds standard clipboard actions to the Edit pull-down menu and supplies the
...
public class Clipboard {
	 ...
	 * @param editMenu
	 *            - The edit pull-down menu (or the pull-down menu you want the
	 *            clipboard actions to reside)
	 */
	 ...
	 *
	 * @param editMenu
	 *            - The edit pull-down menu passed from the constructor.
	 */
	private void initMenu(JMenuItem editMenu) {
		...
		// Readying the keyboard shortcuts for each, depending on what OS they are
		// running
		int modKey = 0;
