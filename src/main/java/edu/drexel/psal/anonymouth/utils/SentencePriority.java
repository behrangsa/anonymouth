...
public class SentencePriority implements Comparable<SentencePriority> {
	...
	/**
	 * Compares two SentencePriority objects and returns: 0: if they have the same
	 * priority -1: if the passed object has a greater priority than the calling
	 * object 1: if the passed object has a lower priority than the calling object
	 */
	@Override
