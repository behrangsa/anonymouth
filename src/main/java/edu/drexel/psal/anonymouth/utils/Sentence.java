...
public class Sentence implements Comparable<Sentence> {
	 ...
	 *            the sentence
	 * @param start
	 *            the (absolute) start index (with respect to the document it came
	 *            from)
	 * @param stop
	 *            the (absolute) stop index (with respect to the document it came
	 *            from)
	 */
	...
	/**
	 * @param escapeChars
	 *            if 'true' will return a string with commas escaped and newlines
	 *            changed (good for CSV formatting)
	 * @return [[ text ](count)] with all commas escaped if escapeComma is set to
	 *         true, normal string otherwise
	 */
	...
	/**
	 * sets the absolute start and stop indices of the sentence with respect to the
	...
	/**
	 * returns the absolute start and stop indices of the sentence with respect to
	 * the document it came from.
	 * 
	 * @return integer array with [start,stop]
	 */
	...
	/**
	 * sets whether or not case will be ignored in the equals method comparison.
	 * 'true' to ignore case, 'false' to take case into account. default is true
	 * (case is unimportant). NOTE: this effects the Sentence class hashCode method.
	 * 
	 * @param shouldIgnore
	 */
	 ...
	 * default is true.
	 * 
	 * @return returns true if equals method ignores case, false if case is
	 *         important.
	 */
	...
	/**
	 * generates a hashcode for Sentence, by calling the String hashCode method on
	 * the sentence text. Unless instructed to do otherwise by the 'setIgnoreCase'
	 * method, hashCodes are generated after converting the text string to
	 * lowercase.
	 * 
	 * @return hashcode
	 */
