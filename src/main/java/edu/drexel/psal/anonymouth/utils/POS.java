...
/**
 * Mapping between POS tags and their description, taken from the Penn Treebank
 * Project
 * 
...
public class POS implements Serializable {
	...
	/**
	 * Enumeration of the POS tags used by the Standford MaxentTagger /Penn
	 * Treebank. These are used as input to the method 'tagToDescription'
	 */
	public enum TheTags {
	...
	/**
	 * Accepts an enumerated tag value from 'TheTags' enumeration, and returns the
	 * description of that tag
	 * 
	 * @param tag
	 *            the enumerated POS tag value from the enumeration 'TheTags'
	 * @return String that describes the input tag, or the input tag itself as a
	 *         string if the tag wasn't found.
	 */
