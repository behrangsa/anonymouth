...
/**
 * Holds an index that corresponds to an array, and a single value. The index is
 * an attribute/feature's position in the Attribute[], and the value holds the
 * number of times that feature appears (in a Word, TaggedSentence, etc.)
 * 
...
public class Reference implements Serializable {
	...
	/**
	 * Equals method to set two References equal to eachother if they hold the same
	 * 'index' (i.e. if they 'point' to the same attribute)
	 */
	...
	/**
	 * generates a hashcode for Reference, modulus 987643211 (an arbitrary large
	 * prime number) to mitigate risk of integer overflow. Multiplier is 31, hash
	 * value starts at 7, and multiplies itself by 'index', and then multiplies
	 * itself by 'value' and adds that to the previous product; at which point, the
	 * modulus is taken.
	 * 
	 * @return hashcode
	 */
	...
	public String toString() {
		return "[" + index + " => " + value + " percentChange: "
				+ DataAnalyzer.topAttributes[index].getPercentChangeNeeded(false, false, false) + "]";
	}
