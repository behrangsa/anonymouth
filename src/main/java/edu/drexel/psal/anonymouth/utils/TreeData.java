...
/**
 * Stores data relating to a tree structure: how many times it
 * appeared/occurred, the strings it was composed of, and how many times each of
 * those strings appeared/occurred, and how many unique strings had the same
 * structure.
 * 
...
public class TreeData {
	 ...
	 * 
	 * @param treeStructure
	 *            should be the processed skeleton of a tree (without the 'words',
	 *            i.e. '(NP (DT ) (NN ))' ) This is made by the {@link processTree}
	 *            method
	 */
	...
	/**
	 * constructor for TreeData. Accepts processed tree skeleton and the
	 * phrase/string of words found within that tree.
	 * 
	...
	/**
	 * returns the processed skeleton of the tree who's data is contained by this
	 * object.
	 * 
	 * @return
	 */
	...
	/**
	 * adds an occurrence of a string to the TreeData object. Automatically updates
	 * number of occurrences of tree structure
	 * 
	 * @param s
	 *            the string to add
	 * @return true
	...
	/**
	 * if the sentences in 'als' are already in this TreeData object, their counts
	 * will be increased by the count of each respective sentence in als. Any
	 * sentence that isn't already in the TreeData object will be added to the
	 * object's sentences along with their respective counts.
	 * 
	 * @param als
	 * @return true
	 */
	 ...
	 * 
	 * @param s
	 *            the string to receive an occurrence count for
	 * @return returns the number of occurrences of a specified string, 0 if no
	 *         occurrences.
	 */
	...
	/**
	 * returns an ArrayList with the text of sentences ordered from greatest to
	 * least by number of occurrences.
	 * 
	...
	/**
	 * returns a single string of the sentence text, ordered by number of
	 * occurrences of each string.
	 * 
	 * @param escapeChars
	 *            if 'true', commas will be escaped and newlines will be changed
	 * @return
	 */
	...
	/**
	 * defines two TreeData objects to be equal if they contain the same processed
	 * tree skeleton (string).
	 * 
	...
	/**
	 * generates a hashcode for TreeData, by calling the String hashCode method on
	 * the processed tree skeleton string. Unless instructed to do otherwise by the
	 * 'setIgnoreCase' method, hashCodes are generated after converting the text
	 * string to lowercase.
	 * 
	 * @return hashcode
	 */
