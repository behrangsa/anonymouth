...
public class RightClickMenu extends JPopupMenu {
	...
	/**
	 * Allows us to enable or disable all our cut, copy, and paste items.
	 *
	 * @param cut
...
/**
 * The MouseAdapter that handles displaying the right-click menu and decides
 * whether or not it's appropriate to enable the combining sentences option
 * (i.e., if the user is only selecting one sentence we can't possible combine
 * it).
 *
 * @author Marc Barrowclift
 */
class PopupListener extends MouseAdapter {
	 ...
	 *
	 * @param popupMenu
	 *            An instance of the menu desired to present when the user right
	 *            clicks.
	 * @param main
	 ...
	 * selected acceptable text and enables/disables combining sentences based on
	 * that.
	 *
	 * @param e
	 */
	private void showPopup(MouseEvent e) {
		/*
		 * While it does seem a bit silly, we need a check to make sure the documentPane
		 * is enabled since this method will get called during the processing stage and
		 * we don't want anything below to be fired during so. This checks to make sure
		 * the user has selected appropriate text for the combine sentences option to be
		 * enabled.
		 */
