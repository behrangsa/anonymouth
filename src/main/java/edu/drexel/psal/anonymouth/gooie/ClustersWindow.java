...
/**
 * A modified version of the existing ClusterPanel such that it will be removed
 * from the main window and relocated to it's own window accessed by the
 * pull-down menu.
 *
...
public class ClustersWindow extends JFrame {
	...
	/**
	 * Constructor, initializes the window and it's components automatically for
	 * you. Also initializes and sets all listeners with it's driver automatically
	 */
	...
	private void initComponents() {
		...
		clustersPanel.setLayout(new MigLayout("wrap, ins 0", "grow, fill", "0[]0[grow, fill][]0"));
		...
		{ // --------------cluster panel components
			...
			clusterHolderPanel.setScrollableUnitIncrement(SwingConstants.VERTICAL, ScrollablePanel.IncrementType.PIXELS,
					74);
