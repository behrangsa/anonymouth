...
public class PropertiesUtil {
	...
	private static final int[][] COLORS = {{255, 255, 0, 128}, // Yellow
			{255, 128, 0, 80}, // Orange
			{0, 128, 255, 80}, // Blue
			{128, 0, 255, 80}}; // Purple
	...
	/**
	 * Resets all values in the prop file to their default values, thereby erasing
	...
	/**
	 * Sets the color to highlight sentences with (must be the index, with respect
	 * to the COLORS array in PreferencesWindow)
	 *
	 * @param color
	 */
	...
	/**
	 * Gets a color object of the saved color to highlight sentences with (for use
	 * when actually creating the highlighter)
	 *
	 * @return
	 */
	...
	/**
	 * Gets the index of the the saved color to highlight sentences with (the index
	 * is with respect to the PreferencesWindow COLORS array)
	 *
	 * @return
	 */
	...
	/**
	 * Sets whether or not to save a version of the document each time the user
	 * processes
	 *
	...
	/**
	 * Gets whether or not to save a version of the document each time the user
	 * processes
	 */
	...
	/**
	 * Sets whether or not to automatically highlight words to remove in a given
	 * sentence
	 *
	 * @param highlight
	 */
	...
	/**
	 * Gets whether or not to automatically highlight words to remove in a given
	 * sentence
	 *
	 * @return
	 */
	...
	/**
	 * Sets whether or not to display the anonymity bar and results tutorial after
	 * processing (so that it's only shown once)
	 *
	 * @param barTutorial
	 ...
	 *
	 * @param fontSize
	 *            - The point-size desired for the font.
	 */
	...
	/**
	 * Sets the index of the current client to use for the next time Anonymouth
	 * loads.
	 *
	 * @param client
	 *            - the index of the client wanted.
	 */
	 ...
	 *
	 * @param availability
	 *            - An ArrayList<String> containing one of two values for each
	 *            client: Either the string "ready" or a date, meaning that the
	 *            client is not ready and will only be available after the specified
	 *            date.
	 */
	 ...
	 *
	 * @return Unlike every other get method here, this return value can be empty if
	 *         the developer hadn't first set the availability (Since there is no
	 *         "default" availability value to fall back on)
	 */
	 ...
	 *
	 * @param translate
	 *            - whether or not the user wants translations
	 */
	 ...
	 *
	 * @param threads
	 *            - the maximum number of threads the user wants used
	 */
	 ...
	 *
	 * @param max
	 *            - the maximum number of features the user wants used
	 */
	 ...
	 *
	 * @param b
	 *            - whether or not the user wants to be warned upon exit of unsaved
	 *            changes
	 */
	 ...
	 *
	 * @param probSet
	 *            - path to the default problem set.
	 */
	 ...
	 *
	 * @return probSet Path to the default problem set, returns "" if none exists.
	 */
