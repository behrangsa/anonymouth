...
/**
 * HighlightMapper stores a highlighted Object as well as its position in the
 * string
 *
...
public class HighlightMapper implements Comparable<HighlightMapper> {
	 ...
	 *
	 * @param start
	 *            - starting index of the highlighted object
	 * @param end
	 *            - ending index of the highlighted object
	 * @param highlightedObject
