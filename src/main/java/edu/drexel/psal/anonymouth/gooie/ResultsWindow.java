...
/**
 * Displays an enlarged, more detailed version of the results graph shown in the
 * main window.
 *
...
public class ResultsWindow extends JFrame {
	...
	private int pictureWidth; // The width of the graph picture, NOT necessarily the width of the window
	// holding it

	/**
	 * Constructor, initializes the results window and all variables needed to
	 * properly display it.
	 *
	 * @param main
	 *            GUIMain instance
	...
	/**
	 * Initializes all variables and things relating to the window itself and not
	 * it's components
	 */
	...
	/**
	 * Makes the data set and main chart from the data given and creates the image
	 * that will be painted to the window when displayed.<br>
	 * <br>
	 * MUST be called first before displaying any windows otherwise it will be
	 * displaying the old results image and not a new image of the newly obtained
	 * results!
	 */
	public void makeChart() {
		...
		chart = ChartFactory.createBarChart("Chance of Document Ownership", "Authors", "Percent Chance", dataSet,
				PlotOrientation.VERTICAL, false, true, false);

		renderer = new CustomRenderer(new Paint[]{Color.red, Color.blue, Color.green, Color.yellow, Color.orange,
		...
		/**
		 * This (hopefully) allows us to have the image itself be larger than the window
		 * if it's too big to all fit nicely in the screen size.
		 */
	...
	/**
	 * Returns a BufferedImage that should be used for the results button in the
	 * main window.<br>
	 * <br>
	 * MUST be called after makeChart() otherwise it will be displaying the old
	 * results image and not a new image of the newly obtained results, or even
	 * worse chart will be null!
	 */
	...
	/**
	 * Add an attribute to the data set which consists of the author and their
	 * percent probability of being the document to anonymize author.
	 *
	 * @param author
	 *            The author name
	 * @param percentage
	...
	/**
	 * Checks to see if the author and percentage data has been acquired and returns
	 * the appropriate boolean.
	 *
	 * @return Whether or not the chart has been created (i.e., do we have any
	 *         authors)
	 */
	 ...
	 *
	 * @return The number of authors currently included in the results data
	 */
	...
	/**
	 * Resets all values and clears all graphs, to be used for reprocessing to make
	 * sure everything's new
	 */
	public void reset() {
		authors.clear();
		percent.clear();
	...
	/**
	 * Checks to see if the author and percentage data has been acquired and the
	 * data's ready to be made into a chart
	 *
	 * @return Whether or not the chart has been created (i.e., do we have any
	 *         authors)
	 */
	...
	/**
	 * Big thanks to JFreeChart, Object Refinery Limited and Contributors, and
	 * MaVRoSCy from StackOverflow for the help.
	 *
	 * <p>
