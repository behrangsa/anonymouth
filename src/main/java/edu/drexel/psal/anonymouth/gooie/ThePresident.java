...
public class ThePresident {
	...
	public ThePresident() {
		...
		if (ANONConstants.IS_MAC) {
			...
			/**
			 * The best method I've found yet for handling the OS X menu look and feel,
			...
			app.addApplicationListener(new ApplicationAdapter() {
				...
				public void handleAbout(ApplicationEvent e) {
					e.setHandled(true); // Tells the system to not display their own "About" window since we've got
					// this covered.
