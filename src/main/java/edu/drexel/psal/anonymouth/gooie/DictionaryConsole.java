...
/**
 * Extends JFrame and allows searching Princeton's Wordnet for both sets of
 * synonyms, as well as words that include specified character grams.
 *
 * <p>
...
public class DictionaryConsole extends javax.swing.JFrame {
	 ...
	 * Runnable() { public void run() { DictionaryConsole inst = new
	 * DictionaryConsole(); inst.setLocationRelativeTo(null); inst.setVisible(true);
	 * } }); }
	 */
	...
	private void initGUI() {
		try {
			...
			thisLayout.setVerticalGroup(thisLayout.createSequentialGroup().addContainerGap().addGroup(thisLayout
					.createParallelGroup()
					.addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
							.addComponent(componentNameLabel, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,
									GroupLayout.PREFERRED_SIZE)
							.addGap(0, 18, Short.MAX_VALUE))
					.addGroup(thisLayout.createSequentialGroup().addGap(0, 24, Short.MAX_VALUE)
							.addGroup(thisLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
									.addComponent(gramSearchLabel, GroupLayout.Alignment.TRAILING, 0, 19,
											Short.MAX_VALUE)
									.addComponent(wordSearchLabel, GroupLayout.Alignment.TRAILING,
											GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,
											GroupLayout.PREFERRED_SIZE))))
					.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
					.addGroup(thisLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
							.addComponent(wordField, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 22,
									GroupLayout.PREFERRED_SIZE)
							.addComponent(gramField, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 22,
									GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
					.addGroup(thisLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
							.addComponent(wordSearchButton, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE,
									GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
							.addComponent(gramSearchButton, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE,
									GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
					.addComponent(viewerTP, GroupLayout.PREFERRED_SIZE, 314, GroupLayout.PREFERRED_SIZE)
					.addGroup(thisLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
							.addComponent(closeButton, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE,
									GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
							.addComponent(notFound, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE,
									GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE))
					.addContainerGap());
							...
							.addGroup(thisLayout.createParallelGroup()
									.addGroup(GroupLayout.Alignment.LEADING,
											thisLayout.createSequentialGroup()
													.addComponent(notFound, GroupLayout.PREFERRED_SIZE, 342,
															GroupLayout.PREFERRED_SIZE)
													.addGap(62))
									.addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
											.addGap(43)
											.addGroup(thisLayout.createParallelGroup()
													.addComponent(wordSearchLabel, GroupLayout.Alignment.LEADING,
															GroupLayout.PREFERRED_SIZE, 220, GroupLayout.PREFERRED_SIZE)
													.addGroup(thisLayout.createSequentialGroup().addGap(24)
															.addGroup(thisLayout.createParallelGroup()
																	.addComponent(wordField,
																			GroupLayout.Alignment.LEADING,
																			GroupLayout.PREFERRED_SIZE, 172,
																			GroupLayout.PREFERRED_SIZE)
																	.addGroup(GroupLayout.Alignment.LEADING, thisLayout
																			...
																			.addGap(22)))
															.addGap(24)))
											.addGap(21).addComponent(componentNameLabel, GroupLayout.PREFERRED_SIZE,
													120, GroupLayout.PREFERRED_SIZE)))
							.addGap(19)
							.addGroup(thisLayout.createParallelGroup()
									.addGroup(thisLayout.createSequentialGroup()
											.addComponent(gramSearchLabel, GroupLayout.PREFERRED_SIZE, 260,
													GroupLayout.PREFERRED_SIZE)
											.addGap(0, 0, Short.MAX_VALUE))
									.addGroup(thisLayout.createSequentialGroup().addGap(44).addGroup(thisLayout
											.createParallelGroup()
											.addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
													.addComponent(gramField, GroupLayout.PREFERRED_SIZE, 172,
															GroupLayout.PREFERRED_SIZE)
													.addGap(0, 44, Short.MAX_VALUE))
											.addGroup(thisLayout.createSequentialGroup().addGap(21).addGroup(thisLayout
													.createParallelGroup()
													.addGroup(GroupLayout.Alignment.LEADING, thisLayout
															.createSequentialGroup()
															.addComponent(gramSearchButton, GroupLayout.PREFERRED_SIZE,
																	129, GroupLayout.PREFERRED_SIZE)
															.addGap(0, 66, Short.MAX_VALUE))
													.addGroup(GroupLayout.Alignment.LEADING,
															thisLayout.createSequentialGroup()
																	.addGap(0, 98, Short.MAX_VALUE).addComponent(
																			closeButton, GroupLayout.PREFERRED_SIZE, 97,
																			GroupLayout.PREFERRED_SIZE)))))))
