...
public class FeatureWizardDriver {
	...
	private static final String NAME = "( FeatureWizardDriver ) - ";
	...
	public static void initListeners(final FeatureWizard fw) {
		...
		fw.avCanonJList.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent arg0) {
				...
				if (fw.avCanonJList.isSelectionEmpty()) {
					...
					Logger.logln(NAME + "Available text pre-processing tool selected at index "
		...
		fw.avCanonAddJButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fw.avCanonJList.isSelectionEmpty()) {
					...
					Logger.logln(NAME + "Added '" + fw.avCanonJList.getSelectedValue()
		...
		fw.selCanonJList.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent arg0) {
				...
				if (fw.selCanonJList.isSelectionEmpty()) {
					...
					Logger.logln(NAME + "Selected text pre-processing tool selected at index "
		...
		fw.avCullJList.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent arg0) {
				...
				if (fw.avCullJList.isSelectionEmpty()) {
					...
					Logger.logln(NAME + "Available feature post-processing tool selected at index "
		...
		fw.avCullAddJButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fw.avCullJList.isSelectionEmpty()) {
					...
					Logger.logln(NAME + "Added '" + fw.avCullJList.getSelectedValue()
		...
		fw.selCullJList.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent arg0) {
				...
				if (fw.selCullJList.isSelectionEmpty()) {
					...
					Logger.logln(NAME + "Feature post-processing tool selected at index "
							+ fw.selCullJList.getSelectedIndex());
		...
		fw.normAddFeatureJButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				CumulativeFeatureDriver cfd = fw.main.ppAdvancedDriver.cfd;
				...
				if (fw.editMode == false) {
					// Add new feature
					fw.main.ppAdvancedDriver.cfd.addFeatureDriver(fw.fd);
					Logger.logln(NAME + "Added feature driver '" + fw.fd.getName()
							+ "' to main feature set. Total feature drivers: "
							+ fw.main.ppAdvancedDriver.cfd.numOfFeatureDrivers());
				} else {
					// Update old feature
					fw.main.ppAdvancedDriver.cfd.replaceFeatureDriverAt(fw.originalIndex, fw.fd);
