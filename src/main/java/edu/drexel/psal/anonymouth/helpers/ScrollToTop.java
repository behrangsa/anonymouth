 ...
 * the text is inserted into the scroll pane. Simply call:<br>
 * <br>
 * SwingUtilities.invokeLater(new ScrollToTop(new Point(0, 0),
 * myScrollPane);<br>
 * <br>
 * To activate after you have set the new text in the respective pane. You may
 * of course feel free to adjust to scroll pane to anywhere you want, not just
 * the top, by changing the numerical values in the Point declaration (however,
 * this is a very awful way to do it, it would be better in this case to update
 * this class to better support abilities like "Scroll to center", "Scroll to
 * Left", etc., but as of now we have no need for that functionality.
 *
...
public class ScrollToTop implements Runnable {
	...
	/**
	 * DO NOT CALL DIRECTLY, in order to adjust your scroll pane use:<br>
	 * <br>
	 * SwingUtilities.invokeLater(new ScrollToTop(new Point(0, 0),
	 * myScrollPane);<br>
	 * <br>
