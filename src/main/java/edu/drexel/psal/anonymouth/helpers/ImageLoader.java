...
/**
 * Provides a convenient interface to load many different kinds of Images that
 * may be needed by Anonymouth
 *
...
public class ImageLoader {
	 ...
	 *
	 * @param name
	 *            The name of the Icon you want to load (Must be in
	 *            resources/graphics)
	 * @return The javax.swing.Icon instance of the file you wanted to load
	 */
